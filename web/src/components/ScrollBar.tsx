...
export function ViewScrollArea({ children, dimentions }: ScrollArea) {
  return (
    <ScrollArea.Root className=" w-[inherit] overflow-hidden h-[inherit]">
      <ScrollArea.Viewport className="relative w-[inherit] h-[inherit] pb-4">
        {children}
      </ScrollArea.Viewport>
